    ...
    <div class="container">
        <div class="row">
          ...
          <input type="hidden" name="id" value="${st.getId() }">
                ...
                <input type="text" id="uname" value="${st.getUname()}" name="uname" class="form-control" onkeyup="validation()">
                    <span id="unameErr" class="text-danger"></span>
            </div>

                <div class="form-group">
                <label for="email">Email</label>
                <input type="email" id="email" value="${st.getEmail()}" name="email" class="form-control"  onkeyup="validation()">
                <span id="emailErr" class="text-danger"></span>
            </div>

                <div class="form-group">
                <label for="pass">Password</label>
                <input type="password" id="pass" value="${st.getPass()}" name="pass" class="form-control"  onkeyup="validation()">
